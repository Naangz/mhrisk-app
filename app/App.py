...
with gr.Blocks(title="Mental Health Risk Prediction - Multi-Model MLOps") as demo:
    ...
    gr.Markdown(
        "Sistem MLOps yang menggunakan multiple algorithms (RandomForest, XGBoost, LightGBM) dan memilih model terbaik"
    )
        ...
        with gr.Row():
            with gr.Column():
                ...
                employment_status = gr.Dropdown(
                    ["Employed", "Unemployed", "Student", "Self-employed"], label="Employment Status"
                )
